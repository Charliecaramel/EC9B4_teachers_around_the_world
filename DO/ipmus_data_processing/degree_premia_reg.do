...
**** Memory management
keep sample_reg l_wage occupation edattain sex age age_sq perwt country country_str year teacher_status 
*******************************************************************************
...
foreach y of local years {
    ...
    * 1. Wage premia for university grads - Baseline regression 
	regress l_wage ib1.occupation##ib3.edattain ib1.sex age age_sq if sample_reg == 1 & year == `y' [pw = perwt], robust
	est store uni_`cname'_`y'
	estadd local education "No"
	estadd local year "`y'"
	
	* 2. Wage premia for university grads - By gender
	regress l_wage ib1.occupation##ib1.sex##ib3.edattain age age_sq if sample_reg == 1 & year == `y' [pw = perwt], robust
